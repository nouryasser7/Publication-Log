            ...
            <div class="proposal-form" style="height:100%;">
                ...
                <div id="proposalForm">
                    <form method="POST" action="" accept-charset="UTF-8"  autocomplete="off" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="zbA2MotMMHQ5NeQA3kYEB2BzYdh0dKWZ0oOwaial">
                        ...
                        <button class="btn btn-success btn-md center-block" type="submit" id="create-proposal-submit" href="<?php echo e(route('submit')); ?>">Save &amp; Continue</button>
                    </form>
                </div>
                </div>
...
<?php /**PATH /Users/nouryasser/publication-log/resources/views/newPublication.blade.php ENDPATH**/ ?>