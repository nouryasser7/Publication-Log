        ...
        <div class="body">
            <div class="proposal-form" style="height:100%;">
                ...
                <div class="list-group">
                    ...
                    <a href="/list-publication/<?php echo e($project->id); ?>" class="list-group-item list-group-item-action">
                        <h4><i><?php echo e($project->title); ?></i></h4>
                        <h4 style="color:#9370DB;">Summary:</h4> <h5 style="font-weight:normal"><?php echo e($project->summary); ?></h5>
                        <h4 style="color:#9370DB;">Scientific Case: </h4><h5 style="font-weight:normal"><?php echo e($project->scientific_case); ?></h5>
...
<?php /**PATH /Users/nouryasser/publication-log/resources/views/welcome.blade.php ENDPATH**/ ?>