                ...
                <div id="proposalForm">
                    <form method="POST" action="" accept-charset="UTF-8"  autocomplete="off" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="zbA2MotMMHQ5NeQA3kYEB2BzYdh0dKWZ0oOwaial">
                        ...
                        <div class="form-group has-success">
                            ...
                            <input class="form-control valid" placeholder="Please enter the title of your paper" name="title" type="text"  id="title" aria-invalid="false" aria-describedby="title-error" value="<?php echo e($publication->title); ?>"><span id="title-error" class="help-block error-help-block"></span>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control valid" id="degree_held" name="author" aria-invalid="false" required>
                                ...
                                <?php $__currentLoopData = $humans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $human): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($human->id); ?>" <?php echo e($human->id == old('author_id') ? 'selected' : ''); ?>><?php echo e($human->first_name); ?> <?php echo e($human->last_name); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control valid" id="degree_held" name="conference" aria-invalid="false" required>
                                ...
                                <?php $__currentLoopData = $conferences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conference): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($conference->id); ?>" <?php echo e($conference->id == old('author_id') ? 'selected' : ''); ?>><?php echo e($conference->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Publication Year" step="1" name="publication_year" min="2000" max="2022" type="number" id="GPU_hours" value="<?php echo e($publication->publication_year); ?>">
                        </div>

                        <div class="custom-file" class="form-group">
                            <label for="basic-url">Upload your Paper</label>
                            <input type="file" name="file" class="custom-file-input" id="customFile" value="<?php echo e($publication->file_name); ?>">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="https://www.example.com" value="<?php echo e($publication->file_url); ?>">
                        </div>

                        <button class="btn btn-success btn-md center-block" type="submit" id="create-proposal-submit" href="<?php echo e(route('successEdit')); ?>">Save &amp; Continue</button>
...
<?php /**PATH /Users/nouryasser/publication-log/resources/views/newForm.blade.php ENDPATH**/ ?>