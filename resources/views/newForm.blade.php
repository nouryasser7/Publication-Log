                ...
                <div id="proposalForm">
                    <form method="POST" action="" accept-charset="UTF-8"  autocomplete="off" novalidate="novalidate" enctype="multipart/form-data"><input name="_token" type="hidden" value="zbA2MotMMHQ5NeQA3kYEB2BzYdh0dKWZ0oOwaial">
                        ...
                        <div class="form-group has-success">
                            ...
                            <input class="form-control valid" placeholder="Please enter the title of your paper" name="title" type="text"  id="title" aria-invalid="false" aria-describedby="title-error" value="{{$publication->title}}"><span id="title-error" class="help-block error-help-block"></span>
...
{{--                        <input name="invisible" type="hidden" value="{{$projectID ?? ''}}">--}}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" placeholder="Publication Year" step="1" name="publication_year" min="2000" max="2022" type="number" id="GPU_hours" value="{{$publication->publication_year}}">
                        </div>

                        <div class="custom-file" class="form-group">
                            <label for="basic-url">Upload your Paper</label>
                            <input type="file" name="file" class="custom-file-input" id="customFile" value="{{$publication->file_name}}">
{{--                            <label class="custom-file-label" for="customFile">Choose file</label>--}}
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="https://www.example.com" value="{{$publication->file_url}}">
                        </div>

                        <button class="btn btn-success btn-md center-block" type="submit" id="create-proposal-submit" href="{{ route('successEdit') }}">Save &amp; Continue</button>
{{--                                                    --}}
                            {{--                        <div class="form-group">--}}
...
{{--                        </div>--}}
{{--                        <div class="btn-wrapper">--}}
{{--                            <button class="btn btn-success btn-md center-block" type="submit" id="create-proposal-submit">Save &amp; Continue</button>--}}
{{--                        </div>--}}
                    </form>
                </div>
