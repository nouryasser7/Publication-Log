...
<div class="container">
    <div class="alert alert-success" role="alert">
        <strong>Publication Edited Successfully!</strong>
    </div>
    <a class="text-center"  href="{{ route('welcome') }}">Go Back to Home</a>

</div>
{{--<button class="btn btn-success btn-md center-block" type="submit" id="create-proposal-submit" href="{{ route('welcome') }}">Go Back to my Publications</button>--}}
